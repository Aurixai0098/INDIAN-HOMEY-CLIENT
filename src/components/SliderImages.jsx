...
const DEMO_REVIEWS = [
  ...
  { id: 9, name: "N Patel", rating: 5, comment: "Ghar Seva never disappoints! The sofa cleaning service made my 5-year-old sofa look brand new.", date: "3 days ago" },
  ...
  { id: 12, name: "P Mishra", rating: 5, comment: "Best decision to use Ghar Seva for my kitchen chimney repair. Works like new now!", date: "5 days ago" },
